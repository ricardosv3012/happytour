                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            ...
                                            <form  action="processAdminServicesDelete.php" method="post">     
                                                
                                                
                                                <?php
                                                    
                                                    $aProcessAdminServices = new ProcessAdminServices();
                                                    echo $aProcessAdminServices->GetOnlyService($_GET['idServices']);
                                                    
                                                ?>
                                                
                                                <div class="form-group">
                                                    <input type="hidden" name="idServices" value="<?php echo $_GET['idServices']?>"
                                                </div>
